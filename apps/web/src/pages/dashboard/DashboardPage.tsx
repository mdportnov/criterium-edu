  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Stats Cards */}
        <Card className="bg-gradient-to-br from-primary to-primary-focus text-white">
          <div className="flex flex-col">
            <div className="text-xl font-semibold mb-2">Total Tasks</div>
        ...
        {user?.role === UserRole.STUDENT && (
          <Card className="bg-gradient-to-br from-accent to-accent-focus text-white">
            <div className="flex flex-col">
              <div className="text-xl font-semibold mb-2">My Solutions</div>
              <div className="text-4xl font-bold">
                {isSolutionsLoading ? (
                  <span className="loading loading-spinner loading-md"></span>
                ) : (
        ...
        {(user?.role === UserRole.ADMIN || user?.role === UserRole.MENTOR) && (
          <Card className="bg-gradient-to-br from-secondary to-secondary-focus text-white">
            <div className="flex flex-col">
              <div className="text-xl font-semibold mb-2">Pending Reviews</div>
              <div className="text-4xl font-bold">
        ...
        {user?.role === UserRole.ADMIN && (
          <Card className="bg-gradient-to-br from-info to-info-focus text-white">
            <div className="flex flex-col">
      ...
      <div className="mt-8">
        <Card
          title={<h2 className="text-xl font-semibold">Recent Tasks</h2>}
          actions={
      ...
      {user?.role === UserRole.STUDENT && (
        <div className="mt-8">
          <Card
            title={<h2 className="text-xl font-semibold">My Recent Solutions</h2>}
            actions={
      ...
      {/* Quick Links Section */}
      <div className="mt-8">
        <Card title={<h2 className="text-xl font-semibold">Quick Links</h2>}>
