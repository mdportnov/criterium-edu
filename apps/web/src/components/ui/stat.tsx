  ...
  return (
    <div
      className={cn(
        ...
        columns === 4 && 'sm:[&>*:nth-child(n+3)]:border-t sm:[&>*:nth-child(n+3)]:border-border lg:[&>*:nth-child(n+3)]:border-t-0',
        columns === 3 && 'sm:[&>*:nth-child(n+3)]:border-t sm:[&>*:nth-child(n+3)]:border-border lg:[&>*:nth-child(n+3)]:border-t-0',
        className,
      )}
      {...props}
    />
